...
module.exports = {
  ...
  create: async function (req, res) {
    try {
      ...
      // let restaurentValue = await schema.restaurentValidationSchema.validateAsync({param})
      // console.log(restaurentValue)
  ...
  findOne: async function (req, res) {
    try {
      ...
      return res.json(foundRestaurent);
    } catch (err) {
  ...
  update: async function (req, res) {
    try {
      ...
      const updation = await Restaurent.update(
        { id: req.params.id },
        updatedRestaurent
      );
